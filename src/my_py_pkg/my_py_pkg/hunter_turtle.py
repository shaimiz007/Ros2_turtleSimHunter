...
class Hunter(Node):
    ...
    def create_route(self,X1,Y1,X2,Y2): #create curve from turtle to killed spawn
        NUM_FIT_POINTS=4
        ...
        for n,y_val in enumerate(y_plot): #treating points the the polinum put outside of screen
            if y_val<0:
                y_plot[n]=-y_val
            elif y_val>11:
                y_plot[n]=22-y_val
        ...
        y_plot[0]=y[0] # asign Y1 & Y2 to the first & last points of the curve
        y_plot[-1]=y[-1]
